...
async def create_line_item(
    ...
    line_item = LineItem(
        ...
        applies_to_dimensions=data.applies_to_dimensions if data.applies_to_dimensions is not None else [],
...
async def update_line_item(
    ...
    if "applies_to_dimensions" in data.model_fields_set:
        line_item.applies_to_dimensions = data.applies_to_dimensions if data.applies_to_dimensions is not None else []
