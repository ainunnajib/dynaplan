...
_BUILTIN_FUNCTIONS: Set[str] = {
    ...
    "CEILING", "FLOOR", "MOD", "SIGN",
    "FINDITEM", "ITEM", "PARENT", "CHILDREN", "ISLEAF", "ISANCESTOR",
    "LOOKUP", "SELECT", "NAME", "CODE", "RANK", "RANKLIST", "COLLECT", "POST",
    "YEARVALUE", "MONTHVALUE", "QUARTERVALUE", "WEEKVALUE", "HALFYEARVALUE",
    "CURRENTPERIODSTART", "CURRENTPERIODEND", "PERIODSTART", "PERIODEND",
    "TIMESUM", "TIMEAVERAGE", "TIMECOUNT",
    "LAG", "LEAD", "OFFSET",
    "MOVINGSUM", "MOVINGAVERAGE", "CUMULATE", "PREVIOUS", "NEXT",
    "INPERIOD", "PERIODOFFSET", "YEARTODATE", "MONTHTODATE", "DATE", "DATEVALUE", "TODAY",
}
